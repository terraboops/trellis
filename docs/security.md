...
Incubator agents run as Claude Code CLI subprocesses. Without hardening,
...
- Profile generated by `incubator/core/sandbox.py` at agent startup
...
Implemented in `incubator/core/tool_policy.py`.
...
- Implemented in `incubator/core/audit.py`
...
- `incubator/agents/*/prompt.py`
- `incubator/agents/global-system-prompt.md`
- `registry.yaml`
